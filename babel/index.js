...
// 词法分析阶段
// 我希望能生成这样一个东西，那如果生成这样一个token流呢？
// [
//     {type:"identifir",value:"const"},
...
const add = (a, b) => a + b
let result = tokenizer('const add = (a, b) => a + b')
...
//           "identifierName": "add",
//           "init": {
//               "type": "ArrowFunctionExpression", // 碰到这个就将箭头函数转换为function
//               "params": [
//                   {
//                       "type": "identifier",
//                       "identifierName": "a"
